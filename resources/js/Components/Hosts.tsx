        ...
        <div className="bg-white py-24">
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-1">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <h2 className="ml-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">is...</h2>
                </div>
                <ul
                    role="list"
                ...
                >
                    {hosts.map((host) => (
                        <li key={host.id}>
                            <img className="aspect-[3/2] w-full rounded-2xl object-cover" src={`storage/${host.avatar}`} alt="" />
                            <h3 className="mt-6 text-lg font-semibold leading-8 text-gray-900">{host.first_name} {host.last_name}</h3>
