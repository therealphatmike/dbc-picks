            ...
            <footer className="bg-white">
                <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                    ...
                    <p className="mt-10 text-center text-xs leading-5 text-gray-500">
                        Door Bumper Clear is owned by Dirty Mo Media. I do not claim rights to these copyrighted and trademarked items.
                    </p>
                    <p className="mt-10 text-center text-xs leading-5 text-gray-500">
                        The structure of this app and presentation of data &copy; {new Date().getFullYear()} T Michael Smith. All rights reserved.
                    </p>
                </div>
            </footer>
        </>
